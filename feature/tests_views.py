...
class TestFeatureViews(TestCase):
    ...
    def test_feature_edit(self):
        ...
        self.assertEqual(new_updated_feature.title,
                         'test_feature_changed')
        self.assertEqual(new_updated_feature.description,
                         'test_description')
    ...
    def test_upvote_feature(self):
        ...
        self.c.get('/feature/upvote_feature/{0}'.format(
            self.feature.id), follow=True)
